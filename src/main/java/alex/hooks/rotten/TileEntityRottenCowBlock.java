...
public class TileEntityRottenCowBlock extends BlockContainer {

    public TileEntityRottenCowBlock(int id) {
        super(id, Material.iron);
        this.setCreativeTab(null);
        this.setBlockBounds(0.0F, -2.0F, 0.0F, 1.0F, 1.0F, 1.0F);
        this.setUnlocalizedName("rottenCow");
    ...
    public TileEntity createNewTileEntity(World world) {
        return new TileEntityRottenCowEntity();
    }
