...
public class SpitSkinnedChickenBlock extends amw {

   public SpitSkinnedChickenBlock(int id) {
      super(id, akc.f);
      this.a((ww)null);
      this.c("spitSkinnedChicken");
      this.c(500.0F);
      this.b(true);
   }
   ...
   public void a(abw par1World, int par2, int par3, int par4, Random par5Random) {
      SpitSkinnedChickenEntity a = (SpitSkinnedChickenEntity)par1World.r(par2, par3, par4);
