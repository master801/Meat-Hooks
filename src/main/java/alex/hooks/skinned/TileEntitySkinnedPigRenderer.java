...
public class TileEntitySkinnedPigRenderer extends TileEntitySpecialRenderer {
    ...
    public void renderTileEntityAt(TileEntity te, double x, double y, double z, float scale) {
        ...
        ResourceLocation textures = new ResourceLocation("Hooks:textures/blocks/skinnedPig.png");
        ...
        this.pigmodel.render(null, 0.0F, 0.0F, -0.1F, 0.0F, 0.0F, 0.0625F);
        GL11.glPopMatrix();
        GL11.glPopMatrix();
    }
