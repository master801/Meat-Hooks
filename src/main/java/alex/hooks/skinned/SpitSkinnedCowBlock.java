...
public class SpitSkinnedCowBlock extends BlockContainer {

   public SpitSkinnedCowBlock(int id) {
      super(id, Material.iron);
      this.setCreativeTab(null);
      this.setUnlocalizedName("spitSkinnedCow");
   ...
   public void updateTick(World par1World, int par2, int par3, int par4, Random par5Random) {
      SpitSkinnedCowEntity a = (SpitSkinnedCowEntity)par1World.getBlockTileEntity(par2, par3, par4);
