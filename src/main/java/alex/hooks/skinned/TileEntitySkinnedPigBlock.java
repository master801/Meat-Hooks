...
public class TileEntitySkinnedPigBlock extends BlockContainer {
    ...
    public void onBlockClicked(World world, int x, int y, int z, EntityPlayer par5EntityPlayer) {
        ...
        par5EntityPlayer.inventory.addItemStackToInventory(new ItemStack(Hooks.iskinnedPig));
    }
