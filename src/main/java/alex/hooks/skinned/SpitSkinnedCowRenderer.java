...
public class SpitSkinnedCowRenderer extends TileEntitySpecialRenderer {

   private final SpitCowModel model = new SpitCowModel();

   @Override
   public void renderTileEntityAt(TileEntity te, double x, double y, double z, float scale) {
      SpitSkinnedCowEntity a = (SpitSkinnedCowEntity)te;
      GL11.glPushMatrix();
      GL11.glTranslatef((float)x + 0.5F, (float)y + 1.5F, (float)z + 0.5F);
      ResourceLocation textures = new ResourceLocation("Hooks:textures/blocks/spitCowSkinned.png");
