...
public class TileEntityHookRenderer extends bje {

   private final HookModel model = new HookModel();


   void adjustRotatePivotViaMeta(abw world, int x, int y, int z) {
   ...
   public void a(asp te, double x, double y, double z, float scale) {
      ...
      bjo textures = new bjo("Hooks:textures/blocks/hook.png");
      atv.w().N.a(textures);
      GL11.glPushMatrix();
