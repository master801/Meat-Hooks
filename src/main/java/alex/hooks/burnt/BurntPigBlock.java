...
public class BurntPigBlock extends BlockContainer {

   public BurntPigBlock(int id) {
      super(id, Material.iron);
      this.setCreativeTab(null);
      this.setUnlocalizedName("burntPig");
