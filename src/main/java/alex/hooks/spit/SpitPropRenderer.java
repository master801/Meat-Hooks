...
import alex.hooks.spit.SpitPropModel;
import org.lwjgl.opengl.GL11;

public class SpitPropRenderer extends TileEntitySpecialRenderer {

   private final SpitPropModel model = new SpitPropModel();

   @Override
   public void renderTileEntityAt(TileEntity te, double x, double y, double z, float scale) {
      GL11.glPushMatrix();
      GL11.glTranslatef((float)x + 0.5F, (float)y + 1.5F, (float)z + 0.5F);
      ResourceLocation textures = new ResourceLocation("Hooks:textures/blocks/spitProp.png");
