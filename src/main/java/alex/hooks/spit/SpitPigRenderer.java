...
public class SpitPigRenderer extends TileEntitySpecialRenderer {

   private final SpitPigModel model = new SpitPigModel();

   @Override
   public void renderTileEntityAt(TileEntity te, double x, double y, double z, float scale) {
      SpitPigEntity a = (SpitPigEntity)te;
      GL11.glPushMatrix();
      GL11.glTranslatef((float)x + 0.5F, (float)y + 1.5F, (float)z + 0.5F);
      ResourceLocation textures = new ResourceLocation("Hooks:textures/blocks/spitPig.png");
