...
public class SkinnedPig extends yc {
   ...
   public SkinnedPig(int id) {
      ...
      this.a(ww.f);
      this.b("iskinnedPig");
      this.d("Hooks".toLowerCase() + ":iskinnedPig");
      this.e(1);
   }
   ...
   public boolean a(ye itemStack, uf player, abw world, int x, int y, int z, int side, float hitX, float hitY, float hitZ) {
      ...
      if(blockId == Hooks.hook.cF) {
         if(world.c(x, y - 1, z)) {
            world.c(x, y, z, Hooks.skinnedPig.cF);
         ...
         world.f(x, y, z, Hooks.spitSkinnedPig.cF, blockMeta, 2);
         player.bn.d(itemStack.d);
      } else {
         ...
         if(world.a(x + 1, y, z) == Hooks.spitStick.cF) {
            world.f(x + 1, y, z, Hooks.spitSkinnedPig.cF, world.h(x + 1, y, z), 3);
         } else if(world.a(x - 1, y, z) == Hooks.spitStick.cF) {
            world.f(x - 1, y, z, Hooks.spitSkinnedPig.cF, world.h(x - 1, y, z), 3);
         } else if(world.a(x, y, z - 1) == Hooks.spitStick.cF) {
            world.f(x, y, z - 1, Hooks.spitSkinnedPig.cF, world.h(x, y, z - 1), 3);
         } else if(world.a(x, y, z + 1) == Hooks.spitStick.cF) {
            world.f(x, y, z + 1, Hooks.spitSkinnedPig.cF, world.h(x, y, z + 1), 3);
         }
